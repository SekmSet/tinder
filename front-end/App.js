...
import { CreateMessaging } from "./src/screen/messaging/create";
...
export default function App() {
  const createRouterMessaging = () => {
    return (
      <Stack.Navigator>
        <Stack.Screen name="List" component={ViewAllMessaging} />
        <Stack.Screen name="Detail" component={ViewDetailMessaging} />
        <Stack.Screen name="Create" component={CreateMessaging} />
      </Stack.Navigator>
    );
  };
      ...
      <PaperProvider theme={theme}>
        <NavigationContainer>
          <Drawer.Navigator>
            ...
            <Drawer.Screen
              name="Messagerie"
              children={createRouterMessaging}
